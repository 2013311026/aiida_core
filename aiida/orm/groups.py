...
class Group(entities.Entity):
    ...
    class Collection(entities.Collection):
        ...
        def get_or_create(self, name, **kwargs):
            ...
            """
            res = self.find(name=name, type_string=kwargs.get("type_string", None))
        ...
        def find(self,
            ...
            """
            return self._backend.groups.query(
                name=name,
    ...
    def __init__(self, name, user=None, description='', type_string='', backend=None):
        ...
        model = backend.groups.create(name=name, user=user, description=description, type_string=type_string)
    ...
    @user.setter
    def user(self, user):
        self._backend_entity.user = user
    ...
    def query(cls,
        ...
        """
        import warnings
        warnings.warn('this method has been deprecated use Group.objects.find() instead', DeprecationWarning)

        return cls.objects(backend).find(
            name=name,
            type_string=type_string,
            pk=pk,
            uuid=uuid,
